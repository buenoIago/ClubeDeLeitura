...
O Clube da Leitura é uma aplicação desenvolvida para realizar o cadastro e o gerenciamento de revistas em quadrinhos, além de controlar os empréstimos feitos aos amigos de Gustavo. O sistema tem como objetivo organizar a coleção, registrar as revistas disponíveis, acompanhar quem realizou cada empréstimo e garantir que todos os exemplares sejam devolvidos corretamente. 

Dessa forma, a aplicação oferece mais segurança, praticidade e controle na administração da coleção.
...
4. Para executar o projeto compilando em tempo real
   ...
   ```bash
   dotnet run --project ClubeDeLeitura.ConsoleApp
   ```
